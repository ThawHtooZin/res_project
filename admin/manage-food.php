      ...
      <div class="wrapper">
        ...
        <table class="tbl-full" width="100%">
          ...
          <tr>
            ...
            <td>
              <a href="update-food.php?id=<?php echo $data['id']; ?>" class="btn btn-secondary">Update User</a>
              <a href="delete-food.php?id=<?php echo $data['id']; ?>" class="btn btn-danger">Delete User</a>
            </td>
          </tr>
          <?php
          }
